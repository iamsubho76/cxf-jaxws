 ...
 * 2017-12-04T01:51:27.258+05:30
 * Generated source version: 3.0.2
 * 
 */
@WebServiceClient(name = "PaymentProcessor", 
                  wsdlLocation = "file:/C:/EASE%20Workspace/cxf-jaxws/cxf-jaxws.javafirsttws.usernametoken.client/src/main/resources/paymentProcessor.wsdl",
                  targetNamespace = "http://client.usernametoken.ws.org.com/") 
public class PaymentProcessor_Service extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://client.usernametoken.ws.org.com/", "PaymentProcessor");
    public final static QName PaymentProcessorPort = new QName("http://client.usernametoken.ws.org.com/", "PaymentProcessorPort");
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/EASE%20Workspace/cxf-jaxws/cxf-jaxws.javafirsttws.usernametoken.client/src/main/resources/paymentProcessor.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PaymentProcessor_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/EASE%20Workspace/cxf-jaxws/cxf-jaxws.javafirsttws.usernametoken.client/src/main/resources/paymentProcessor.wsdl");
        }
        WSDL_LOCATION = url;
    }
