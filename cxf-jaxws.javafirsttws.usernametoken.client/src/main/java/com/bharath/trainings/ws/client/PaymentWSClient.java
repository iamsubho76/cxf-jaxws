...
import com.org.ws.usernametoken.client.PaymentProcessor;
import com.org.ws.usernametoken.client.PaymentProcessorRequest;
import com.org.ws.usernametoken.client.PaymentProcessorResponse;
import com.org.ws.usernametoken.client.PaymentProcessor_Service;
	...
	public static void main(String[] args) {
		...
		try {
			PaymentProcessor_Service service = new PaymentProcessor_Service(new URL(
					"http://localhost:8080/javafirstwsut/services/paymentProcessor?wsdl"));
