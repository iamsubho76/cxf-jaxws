 ...
 * 2017-12-03T23:39:04.854+05:30
 * Generated source version: 3.0.2
 * 
 */
@WebServiceClient(name = "CustomerOrdersService", 
                  wsdlLocation = "file:/C:/EASE%20Workspace/cxf-jaxws/cxf-jaxws.wsdlfirstws.server/src/main/webapp/WEB-INF/wsdl/CustomerOrders.wsdl",
...
public class CustomerOrdersService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/EASE%20Workspace/cxf-jaxws/cxf-jaxws.wsdlfirstws.server/src/main/webapp/WEB-INF/wsdl/CustomerOrders.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerOrdersService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/EASE%20Workspace/cxf-jaxws/cxf-jaxws.wsdlfirstws.server/src/main/webapp/WEB-INF/wsdl/CustomerOrders.wsdl");
        }
        WSDL_LOCATION = url;
    }
