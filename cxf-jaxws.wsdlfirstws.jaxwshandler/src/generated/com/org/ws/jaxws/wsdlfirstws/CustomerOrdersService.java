 ...
 * 2017-12-04T02:12:45.232+05:30
 * Generated source version: 3.0.2
 * 
 */
@WebServiceClient(name = "CustomerOrdersService", 
                  wsdlLocation = "file:/C:/EASE%20Workspace/cxf-jaxws/cxf-jaxws.wsdlfirstws.jaxwshandler/src/main/webapp/WEB-INF/wsdl/CustomerOrders.wsdl",
                  targetNamespace = "http://wsdlfirstws.jaxws.ws.org.com/") 
public class CustomerOrdersService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://wsdlfirstws.jaxws.ws.org.com/", "CustomerOrdersService");
    public final static QName CustomerOrdersPort = new QName("http://wsdlfirstws.jaxws.ws.org.com/", "CustomerOrdersPort");
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/EASE%20Workspace/cxf-jaxws/cxf-jaxws.wsdlfirstws.jaxwshandler/src/main/webapp/WEB-INF/wsdl/CustomerOrders.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerOrdersService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/EASE%20Workspace/cxf-jaxws/cxf-jaxws.wsdlfirstws.jaxwshandler/src/main/webapp/WEB-INF/wsdl/CustomerOrders.wsdl");
        }
        WSDL_LOCATION = url;
    }
